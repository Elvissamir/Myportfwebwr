const PhpIcon = () => {
    return (
        <svg className="php-icon icon" width="256px" height="256px" viewBox="0 -60.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <defs>
