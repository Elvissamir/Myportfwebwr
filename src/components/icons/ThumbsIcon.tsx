const ThumbsIcon = () => {
    return (
        <svg className="thumbs-icon icon" version="1.1"
            id="svg2" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="1200px" height="1200px"
            viewBox="0 0 1200 1200" enableBackground="new 0 0 1200 1200" xmlSpace="preserve">
            <path id="path23781" d="M717.534,60.514c42.51-0.457,82.729,43.455,110.594,74.778
