const FirebaseIcon = () => {
    return (
        <svg className="firebase-icon icon" width="351px" height="351px" viewBox="-47.5 0 351 351" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid">
            <defs>
